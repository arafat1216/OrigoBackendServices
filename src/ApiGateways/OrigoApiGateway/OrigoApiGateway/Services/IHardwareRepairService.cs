...
namespace OrigoApiGateway.Services
{
    ...
    {
        // Configuration
        Task<LegacyCustomerSettings> ConfigureServiceIdAsync(Guid customerId, string serviceId);
        Task<LegacyCustomerSettings> ConfigureLoanPhoneAsync(Guid customerId, LoanDevice loanDevice);
        Task<LegacyCustomerSettings> GetSettingsAsync(Guid customerId);
