...
namespace OrigoApiGateway.Services
{
    public interface IAssetServices
    {
        ...
        Task<PagedModel<HardwareSuperType>> GetAssetsForCustomerAsync(Guid customerId,string userId, FilterOptionsForAsset filterOptions, string search = "", int page = 1, int limit = 1000);
