...
namespace CustomerServices.Models
{
    public interface IOrganizationRepository
    {
        ...
        Task<List<User>> GetAllUsersAsync(Guid customerId, string[]? role, Guid[]? assignedToDepartment, IList<int>? UserStatus, CancellationToken cancellationToken, string search = "", int page = 1, int limit = 100);
