...
public class AssetServicesTests : AssetBaseTest
{
    ...
    public async Task GetAssetsForCustomer_ForOneCustomer_CheckCount()
    {
        ...
        // Act
        var assetsFromUser =
            await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID,null, null, null, null, null, null, null ,string.Empty, 1, 10,
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, userId, null, null, null, null, null, null, null, 1, 10,
             new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, null, labels, null, null, null, 1, 10,
             new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, category, null, null, null, null, 1, 10,
             new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, depts, null, null, null, null, null, 1, 10, new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, status, null, null, null, null, null, null, 1, 10,
            new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, status, depts, category, labels, null, null, null, 1, 10,
             new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, null, null, null, null, "123456789012399", 1, 10,
             new CancellationToken());
        ...
        // search with IMEI
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, null, null, null, null, "512217111821626", 1, 10,
             new CancellationToken());
        ...
        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, null, null, true, true, null, 1, 10,
             new CancellationToken());

        // Assert 
        Assert.Equal(2, assetsFromUser.Items.Count);

        assetsFromUser = await assetService.GetAssetLifecyclesForCustomerAsync(COMPANY_ID, null, null, null, null, null, false, true, null, 1, 10,
             new CancellationToken());
