...
namespace AssetServices.UnitTests
{
    public class AssetBaseTest
    {
        ...
        protected readonly Guid ASSET_THREE_ID = new("80665d26-90b4-4a3a-a20d-686b64466f32");
        ...
        private void Seed()
        {
            ...
            var assetFour = new MobilePhone(Guid.NewGuid(), COMPANY_ID, "alias_3", assetCategory, "123456789012399", "Samsung", "Samsung Galaxy S21",
            ...
            var assetOther = new MobilePhone(Guid.NewGuid(), Guid.NewGuid(), "alias_4", assetCategory, "123457789012399", "Samsung", "Samsung Galaxy S21",
            ...
            context.Assets.AddRange(assetOne, assetTwo, assetThree, assetFour, assetOther);
