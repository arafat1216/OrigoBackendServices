...
namespace AssetServices.Migrations
{
    ...
    [Migration("20220701072222_customerlabel_manytomany")]
    partial class customerlabel_manytomany
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetLifecycleCustomerLabel", b =>
                {
                    b.Property<int>("AsssetLifecyclesId")
                        .HasColumnType("int");

                    b.Property<int>("LabelsId")
                        .HasColumnType("int");

                    b.HasKey("AsssetLifecyclesId", "LabelsId");
            ...
            modelBuilder.Entity("AssetLifecycleCustomerLabel", b =>
                {
                    b.HasOne("AssetServices.Models.AssetLifecycle", null)
                        .WithMany()
                        .HasForeignKey("AsssetLifecyclesId")
