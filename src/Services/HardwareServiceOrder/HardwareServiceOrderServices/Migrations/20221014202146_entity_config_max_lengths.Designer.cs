...
namespace HardwareServiceOrderServices.Migrations
{
    ...
    [Migration("20221014202146_entity_config_max_lengths")]
    partial class entity_config_max_lengths
    {
            ...
            modelBuilder.Entity("HardwareServiceOrderServices.Models.CustomerServiceProvider", b =>
                {
                    ...
                    b
                        .HasComment("Configures a customer's service-provider settings.")
            ...
            modelBuilder.Entity("HardwareServiceOrderServices.Models.ServiceOrderAddon", b =>
                {
                    ...
                    b
                        .HasComment("The service-order addons that is offered by a given service-provider.")
                        .ToTable(tb => tb.IsTemporal(ttb =>
                        {
                            ttb
                                .HasPeriodStart("PeriodStart")
            ...
            modelBuilder.Entity("HardwareServiceOrderServices.Models.ServiceProviderServiceType", b =>
                {
                    ...
                    b
                        .HasComment("Determines what service-types is available for a given service-provider.")
                        .ToTable(tb => tb.IsTemporal(ttb =>
                        {
                            ttb
                                .HasPeriodStart("PeriodStart")
