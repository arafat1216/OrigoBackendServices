...
{
    /// <summary>
    ///     Contains the new/updated data that is returned by the external service-provider after a new service-order has been created.
    ///     What information that's available may differ between providers.
    /// </summary>
    public class NewExternalServiceOrderResponseDTO
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="NewExternalServiceOrderResponseDTO"/> class.
        /// </summary>
        ...
        public NewExternalServiceOrderResponseDTO(string serviceProviderOrderId1, string? serviceProviderOrderId2 = null, string? externalServiceManagementLink = null)
        {
