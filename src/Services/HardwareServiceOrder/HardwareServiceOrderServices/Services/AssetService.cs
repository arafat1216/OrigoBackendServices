...
namespace HardwareServiceOrderServices.Services
{
    ...
    public class AssetService : IAssetService
    {
        ...
        /// <inheritdoc/>
        public async Task UpdateAssetLifeCycleStatusAsync<TRequest>(string endpointSuffix, Guid assetLifecycleId, TRequest data)
        {
            HttpResponseMessage? result = null;
            JsonContent content = JsonContent.Create(data);
            result = await _httpClient.PatchAsync($"{_config.ApiPath}/{assetLifecycleId}/{endpointSuffix}", content);
