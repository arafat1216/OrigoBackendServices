...
#pragma warning restore CS0618 // Type or member is obsolete
            ...
            Assert.Equal(order.ExternalServiceManagementLink, assetRepairEmail.ShippingLabelLink);
        ...
        public void HardwareServiceOrderToOrderCancellationEmail()
        {
            ...
            var serviceProvider = new ServiceProvider("ServiceProviderName", Guid.NewGuid(), true, true);
