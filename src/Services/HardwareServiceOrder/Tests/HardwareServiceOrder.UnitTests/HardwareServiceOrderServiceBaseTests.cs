...
namespace HardwareServiceOrder.UnitTests
{
    public class HardwareServiceOrderServiceBaseTests
    {
        ...
        private void Seed()
        {
            ...
            var order1 = new HardwareServiceOrderServices.Models.HardwareServiceOrder(CUSTOMER_ONE_ID, new ContactDetails(CUSTOMER_ONE_ID, "FirstName", "LastName", "test@test.com", "PhoneNumber"), Guid.NewGuid(), deliveryAddress, "UserDescription", serviceProvider, "serviceProviderOrderId1", null, "externalLink", serviceType, new ServiceStatus { Id = 100 });
            ...
            var order4 = new HardwareServiceOrderServices.Models.HardwareServiceOrder(CALLER_ONE_ID, CUSTOMER_FOUR_ID, Guid.NewGuid(), "UserDescription", new ContactDetails(CUSTOMER_ONE_ID, "FirstName", "LastName", "test@test.com", "PhoneNumber"), deliveryAddress, 1, 1, 1, "serviceProviderId1", "serviceProviderId2", "externalLink", new List<ServiceEvent>());
