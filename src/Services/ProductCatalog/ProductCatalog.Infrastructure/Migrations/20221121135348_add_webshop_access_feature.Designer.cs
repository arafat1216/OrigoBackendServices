...
namespace ProductCatalog.Infrastructure.Migrations
{
    ...
    [Migration("20221121135348_add_webshop_access_feature")]
    partial class add_webshop_access_feature
    {
            ...
            modelBuilder.Entity("ProductCatalog.Infrastructure.Models.Database.Feature", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            AccessControlPermissionNode = "BasicSubscriptionManagement",
                            FeatureTypeId = 1,
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = 4,
                            AccessControlPermissionNode = "BasicNonPersonalAssetManagement",
                            FeatureTypeId = 1,
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = 5,
                            AccessControlPermissionNode = "BasicBookValueManagement",
                            FeatureTypeId = 1,
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            Id = 6,
                            AccessControlPermissionNode = "BasicTransactionalAssetReturn",
                            FeatureTypeId = 2,
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        ...
                        {
                            Id = 17,
                            AccessControlPermissionNode = "WebshopAccess",
                            FeatureTypeId = 1,
                            UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
                    ...
                    b.OwnsMany("ProductCatalog.Infrastructure.Models.Database.FeatureTranslation", "Translations", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                new
                                {
                                    FeatureId = 3,
                                    Language = "en",
                                    Description = "Allows organizations to perform the basic subscription management tasks.",
                                    Name = "Basic Subscription Management",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                    FeatureId = 3,
                                    Language = "nb",
                                    Description = "Lar en organisasjon utføre grunnleggende behandling av abonnementer.",
                                    Name = "Grunnleggende abonnement-håndtering",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                    FeatureId = 4,
                                    Language = "en",
                                    Description = "Allows organizations to perform non-personal asset management tasks.",
                                    Name = "Basic Non-personal Asset Management",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                ...
                                new
                                {
                                    ...
                                    Name = "Basic Book Value Management",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                ...
                                new
                                {
                                    FeatureId = 6,
                                    Language = "en",
                                    Description = "Makes it possible to use the 'return' functionality on supported transactional devices. This enables the most basic 'internal return' functionality, and is required when using/activating some of the more advanced return functionality.",
                                    Name = "Basic asset return (transactional)",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                    FeatureId = 6,
                                    Language = "nb",
                                    Description = "Gjør det mulig å benytte 'returner' funksjonaliteten på støttede transaksjonelle enheter. Dette tilgjengeliggjør den mest grunnleggende 'intern retur' funksjonaliteten, og er nødvendig for å kunne bruke/aktivere noen av de mer avanserte retur funksjonalitetene.",
                                    Name = "Grunnleggende asset retur (transaksjonell)",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                ...
                                new
                                {
                                    FeatureId = 17,
                                    Language = "en",
                                    Description = "Allows Users to visit web shop page.",
                                    Name = "Webshop Access",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                },
                                new
                                {
                                    FeatureId = 17,
                                    Language = "nb",
                                    Description = "Lar brukere besøke nettbutikksiden.",
                                    Name = "Tilgang til nettbutikk",
                                    UpdatedBy = new Guid("00000000-0000-0000-0000-000000000001")
                                });
                        });
